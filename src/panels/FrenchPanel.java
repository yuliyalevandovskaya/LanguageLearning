...
public class FrenchPanel extends JPanel {

    public FrenchPanel(DictionaryPanel dictionaryPanel)
    {
            ...
            if(Words.checkTranslationFrench(wordsSet, word.getText().trim()).equals(translation.getText().trim())){
                ...
                for(Words w : wordsSet)
                {
                    if(w.getEnglish().matches(word.getText().trim())){
                        if(w.getFrenchCounter() < 100){
                            w.setFrenchCounter(w.getFrenchCounter() + 25);
                        }
                        database.updateFrenchCounter(w);
